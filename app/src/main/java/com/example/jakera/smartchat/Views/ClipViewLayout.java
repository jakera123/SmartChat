...
import static com.example.jakera.smartchat.Utils.FileUtil.getRealFilePathFromUri;
import static com.example.jakera.smartchat.Utils.FileUtil.getRealFilePathFromUri1;

/**
 * 头像上传原图裁剪容器
 * https://github.com/wsy858/android-headimage-cliper/blob/master/app/src/main/java/evan/wang/ClipImageActivity.java
 */
public class ClipViewLayout extends RelativeLayout {
    ...
    public void initSrcPic(Uri uri) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            path = getRealFilePathFromUri(getContext(), uri);
        } else {
            path = getRealFilePathFromUri1(getContext(), uri);
        }
